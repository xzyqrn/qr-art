...
export const PRESET_ICONS: PresetIcon[] = [
  ...
  },
  {
    ...
    name: "Phone",
    category: "contact",
    svg: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><rect width="24" height="24" rx="5.4" fill="#34C759"/><path fill="#ffffff" transform="translate(3.15 3.15) scale(0.7375)" d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.331a49.809 49.809 0 006.108 6.108c.083.038.23.009.331-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z"/></svg>`,
  },
];
